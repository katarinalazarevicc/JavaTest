...
public class CalculatingTest {
    ...
    @Test
    public void checkingFinishDateIfProgramIsEmpty() {
    ...
    @Test
    public void startDateCantBeSaturday(){
    ...
    @Test
    public void startDateCantBeSunday(){
    ...
    @Test
    public void finishDateCantBeSaturday(){
        Program javaDeveloper = new Program("Java Developer");
    ...
    @Test
    public void finishDateCantBeSunday(){
        Program javaDeveloper = new Program("Java Developer");
